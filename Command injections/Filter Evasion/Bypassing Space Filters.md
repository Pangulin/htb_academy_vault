...
Now that we have a working injection operator, let us modify our original payload and send it again as (`127.0.0.1%0a whoami`): ![Filter Space](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_spaces_1.jpg)
#### Using Tabs
...
Let us use `${IFS}` and see if it works (`127.0.0.1%0a<span style="color:rgb(255, 0, 0)">${IFS</span>}`): ![Filter Space](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_spaces_4.jpg)
