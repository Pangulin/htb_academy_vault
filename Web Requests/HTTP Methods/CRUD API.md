...
```shell-session
Pangulin@htb[/htb]$ curl http://<SERVER_IP>:<PORT>/api.php/city/london
...
```shell-session
Pangulin@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/london | jq
...
```shell-session
Pangulin@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/le | jq
...
```shell-session
Pangulin@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/ | jq
...
```shell-session
Pangulin@htb[/htb]$ curl -X POST http://<SERVER_IP>:<PORT>/api.php/city/ -d '{"city_name":"HTB_City", "country_name":"HTB"}' -H 'Content-Type: application/json'
```
...
```shell-session
Pangulin@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/HTB_City | jq
...
```shell-session
Pangulin@htb[/htb]$ curl -X PUT http://<SERVER_IP>:<PORT>/api.php/city/london -d '{"city_name":"New_HTB_City", "country_name":"HTB"}' -H 'Content-Type: application/json'
```
...
```shell-session
Pangulin@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/New_HTB_City | jq
...
```shell-session
Pangulin@htb[/htb]$ curl -X DELETE http://<SERVER_IP>:<PORT>/api.php/city/New_HTB_City
```
