...
```shell-session
Pangulin@htb[/htb]$ curl -i http://<SERVER_IP>:<PORT>/
...
```shell-session
Pangulin@htb[/htb]$ curl -u admin:admin http://<SERVER_IP>:<PORT>/
...
```shell-session
Pangulin@htb[/htb]$ curl http://admin:admin@<SERVER_IP>:<PORT>/
...
```shell-session
Pangulin@htb[/htb]$ curl -v http://admin:admin@<SERVER_IP>:<PORT>/
...
```shell-session
Pangulin@htb[/htb]$ curl -H 'Authorization: Basic YWRtaW46YWRtaW4=' http://<SERVER_IP>:<PORT>/
...
```shell-session
Pangulin@htb[/htb]$ curl 'http://<SERVER_IP>:<PORT>/search.php?search=le' -H 'Authorization: Basic YWRtaW46YWRtaW4='
