...
```shell-session
Pangulin@htb[/htb]$ curl inlanefreight.com
...
```shell-session
Pangulin@htb[/htb]$ curl -O inlanefreight.com/index.html
Pangulin@htb[/htb]$ ls
index.html
```
...
```shell-session
Pangulin@htb[/htb]$ curl -s -O inlanefreight.com/index.html
```
