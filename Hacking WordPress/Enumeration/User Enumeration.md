...
```shell-session
Pangulin@htb[/htb]$ curl -s -I -X GET http://blog.inlanefreight.com/?author=1
...
```shell-session
Pangulin@htb[/htb]$ curl -s -I -X GET http://blog.inlanefreight.com/?author=100
...
```shell-session
Pangulin@htb[/htb]$ curl http://blog.inlanefreight.com/wp-json/wp/v2/users | jq
